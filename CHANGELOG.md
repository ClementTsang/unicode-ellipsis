...
- Bump of `unicode-segmentation`. I bumped this by a major version just in case this affects some behaviour.

## 0.4.0

### Other

- Bump of internal dependencies. I bumped this by a major version just in case this affects some behaviour.
